...
const ModalPageAddCtg = (props) => {
  ...
  const addWord = () => {
    ...
    if (text.length > 15) {
      return Alert.alert(
        "Warn!",
        "Category Name Is Very Larg ,Should Be Less Than 15 Letters"
      );
    } else {
      try {
        db.transaction((tx) => {
...
export default ModalPageAddCtg;

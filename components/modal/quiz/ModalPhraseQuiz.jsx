...
const ModalPhraseQuiz = (props) => {
  ...
  const [phraseMean, setPhraseMean] = useState("");
  ...
  scrollToIndex = () => {
    if (text.trim() == "") {
      ...
      if (text.trim().toLowerCase() == phraseMean.trim().toLowerCase()) {
        Chack("#00cc00");
        setScore(score + 1);
        fadeIn(1000);
        setExitVisible("none");
      ...
      const timerId = setTimeout(() => {
        ...
        if (indexNumber == props.AllPhrases.length) {
          setVisibleQuiz("none");
          ...
          return (
            <>
              ...
              >
                ...
                >
                  <Text style={styles.answerText}>{item.phrase}</Text>
                </Animated.View>
                </View>
              </View>
            </>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {(score * 100) / props.AllPhrases.length > 85
                ? "Excellent"
                : (score * 100) / props.AllPhrases.length > 65
                ? "Good"
                : (score * 100) / props.AllPhrases.length > 50
                ? "Not Bad"
                : "Try Again"}
            </Text>
            ...
            >
              {/*  */}
              {((score * 100) / props.AllPhrases.length).toFixed(0)} %
            </Text>
          </View>
        </View>
      </View>
...
export default ModalPhraseQuiz;
